...
def run_inference(model, tokenizer, prompt_system, prompt_user):
    ...
    # 1. Aplicar el formato de Llama 3.1 y obtener el texto crudo (tokenize=False)
    ...
    # 2. Tokenizar explícitamente para asegurar un diccionario de tensores perfecto
    inputs = tokenizer(prompt_text, return_tensors="pt").to(model.device)

    # Definir los terminadores de Llama 3.1
    terminators = [
    ...
    # 3. Inyectar los inputs de manera segura usando **inputs
    ...
    # 4. Medir el tamaño del input para recortarlo de la salida y dejar solo la respuesta nueva
